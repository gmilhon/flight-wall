// Aircraft type silhouettes (top-view, nose-up), keyed by a coarse category
// derived from the ICAO type code (with the ADS-B emitter category as a hint).
// Used both as the card's type icon and as the rotated map marker.
